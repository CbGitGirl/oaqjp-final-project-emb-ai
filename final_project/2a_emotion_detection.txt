"""IBM Watson NLP emotion detector for the final project."""
...
def emotion_detector(text_to_analyze: str | None) -> dict[str, float | str | None]:
    """Analyze text and return Watson's five emotion scores and dominant emotion."""
